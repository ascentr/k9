# Generated by Django 3.1.4 on 2022-10-07 02:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flavour', models.CharField(blank=True, max_length=200)),
                ('discription', models.TextField(default='')),
                ('image', models.ImageField(blank=True, null=True, upload_to='')),
                ('brand', models.ForeignKey(blank=True, default=1, on_delete=django.db.models.deletion.CASCADE, related_name='product_brand', to='store.brand')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
